...
using Articy.ManiacManfred.GlobalVariables;

namespace Articy.ManiacManfred
{
    
    
    [CustomEditor(typeof(Articy.ManiacManfred.GlobalVariables.ArticyGlobalVariables))]
    ...
    public class GlobalVariablesMenuItems
    {
        ...
        {
Articy.Unity.Editor.Utils.ArticyEditorUtility.CreateGlobalVariablesClone<Articy.ManiacManfred.GlobalVariables.ArticyGlobalVariables>();
        }
    }
}
